...
import {JSBI,Token,CurrencyAmount,TokenAmount, Fraction, Percent,Currency} from '../../sdk'
...
import { getOkLinkLink, isAddress } from '../../utils'
  ...
  return (
    <AutoColumn gap="20px">
      <Body my={9} style={{ fontWeight: 400 }}>
        ...
        {chainId && (
          <ExternalLink href={getOkLinkLink(chainId, MIGRATOR_ADDRESS, 'address')}>

...
import { shortenAddress, getOkLinkLink } from '../../utils'
                      ...
                      <div>
                        ...
                        {chainId && account && (
                          <AddressLink
                            hasENS={!!ENSName}
                            isENS
                            href={chainId && getOkLinkLink(chainId, ENSName, 'address')}
                          >
                            <LinkIcon size={16} />
                            <span style={{ marginLeft: '4px' }}> <TranslatedText translationId={772}>View on Oklink</TranslatedText></span>
                          </AddressLink>
                        )}
                      </div>
                    </AccountControl>
                      ...
                      <div>
                        ...
                        {chainId && account && (
                          <AddressLink
                            hasENS={!!ENSName}
                            isENS={false}
                            href={getOkLinkLink(chainId, account, 'address')}
                          >
                            <LinkIcon size={16} />
                            <span style={{ marginLeft: '4px' }}> <TranslatedText translationId={772}>View on Oklink</TranslatedText></span>
                          </AddressLink>
      ...
      {!!pendingTransactions.length || !!confirmedTransactions.length ? (
        <LowerSection>
          <AutoRow mb="1rem" style={{ justifyContent: 'space-between' }}>
            <Body><TranslatedText translationId={946}>Recent Transactions</TranslatedText></Body>

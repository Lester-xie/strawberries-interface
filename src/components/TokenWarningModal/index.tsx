...
import { getOkLinkLink, shortenAddress } from '../../utils'
    ...
    <Wrapper error={duplicateNameOrSymbol}>
      <AutoRow gap="6px">
        ...
        <AutoColumn gap="10px" justify="flex-start">
          ...
          {chainId && (
            <ExternalLink style={{ fontWeight: 400 }} href={getOkLinkLink(chainId, token.address, 'token')}>
              <Text title={token.address}>{shortenAddress(token.address)} (View on OkLink)</Text>
            </ExternalLink>
          )}
        </AutoColumn>
      </AutoRow>
    ...
    <Modal isOpen={isOpen} onDismiss={handleDismiss} maxHeight={90}>
      <WarningContainer className="token-warning-container">
        <AutoColumn gap="lg">
          ...
          <Text>
            Anyone can create an BEP20 token on OkExChain with <em>any</em> name, including creating fake versions of existing

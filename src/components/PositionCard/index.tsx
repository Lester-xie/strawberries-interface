              ...
              <FixedHeightRow>
                <RowFixed>
                  <Text style={{ textTransform: 'uppercase', fontWeight: 600 }} fontSize="14px" color="textSubtle">
                    {TranslateString(1336, 'LP Tokens in your Wallet')}
                  </Text>
                </RowFixed>
              </FixedHeightRow>
      ...
      <AutoColumn gap="12px">
        ...
        {showMore && (
          <AutoColumn gap="8px">
            <FixedHeightRow>
              <RowFixed>
                <Text>{TranslateString(868,'Pooled')} {currency0.symbol}:</Text>
              </RowFixed>
              {token0Deposited ? (
                <RowFixed>
            ...
            <FixedHeightRow>
              <RowFixed>
                <Text>{TranslateString(868,'Pooled')} {currency1.symbol}:</Text>
              </RowFixed>
              {token1Deposited ? (
                <RowFixed>
            ...
            <FixedHeightRow>
              <Text>{TranslateString(870, 'Your pool tokens: ')}</Text>
              <Text>{userPoolBalance ? userPoolBalance.toSignificant(4) : '-'}</Text>
            </FixedHeightRow>
            <FixedHeightRow>
              <Text>{TranslateString(872, 'Your pool share:')}</Text>
